...
def get_input_stream(
    ...
    server handles terminating the stream, so it is safe to read directly. For examples,
    ...
    if "wsgi.input_terminated" in environ:
        if max_content_length is not None:
            ...
            # is made when the client sends no data. For examples, the development server
