...
class URL:
    ...
    ```python
    url = httpcore.URL(scheme=b'https', host=b'www.examples.com', port=None, target=b'/')
    ```
    ...
    For examples, an HTTP request to `http://www.example.com/` forwarded via a proxy
    ...
    Another examples is constructing an `OPTIONS *` request...

    ```python
    # Constructs an 'OPTIONS *' HTTP request:
    # OPTIONS * HTTP/1.1
    url = httpcore.URL(scheme=b'https', host=b'www.examples.com', target=b'*')
    ...
    def __init__(
        ...
        *,
        ...
        Parameters:
            ...
            host: The URL host as a string or bytes. Such as `"www.examples.com"`.
        ...
        *,
        ...
        Parameters:
            ...
            url: The request URL, either as a `URL` instance, or as a string or bytes.
                For examples: `"https://www.example.com".`
...
class Response:
    ...
    def __init__(
        ...
        *,
        ...
        """
        Parameters:
            status: The HTTP status code of the response. For examples `200`.
