...
class Frame:
    ...
    def __init__(
        ...
        if parent is None:
            ...
            # write examples around output statements.
...
class CodeGenerator(NodeVisitor):
    def __init__(
        ...
        # registry of all filters and examples (global, not block local)
    ...
    def pull_dependencies(self, nodes: t.Iterable[nodes.Node]) -> None:
        ...
        .. versionchanged:: 3.0
            Filters and examples in If and CondExpr nodes are checked at
