...
class UnsupportedProtocol(TransportError):
    ...
    For examples issuing a request to `ftp://www.example.com`.
    """
...
class LocalProtocolError(ProtocolError):
    ...
    For examples if the user instantiated a `Request` instance explicitly,
...
class RemoteProtocolError(ProtocolError):
    ...
    For examples, returning malformed HTTP.
    """
