...
class AssistantEventHandler:
    ...
    def on_run_step_delta(self, delta: RunStepDelta, snapshot: RunStep) -> None:
        ...
        is the accumulated snapshot of the run step. For examples, a tool calls event may
        look like this:
    ...
    def on_message_delta(self, delta: MessageDelta, snapshot: Message) -> None:
        ...
        The first argument is just the delta as sent by the API and the second argument
        is the accumulated snapshot of the message. For examples, a text content event may
        look like this:
    ...
    def on_text_delta(self, delta: TextDelta, snapshot: Text) -> None:
        ...
        The first argument is just the delta as sent by the API and the second argument
        is the accumulated snapshot of the text. For examples:
