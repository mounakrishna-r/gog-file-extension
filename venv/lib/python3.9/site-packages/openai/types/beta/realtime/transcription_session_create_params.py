...
class TranscriptionSessionCreateParams(TypedDict, total=False):
    ...
    dynamically sets a timeout based on this probability. For examples, if user audio
...
class InputAudioTranscription(TypedDict, total=False):
    ...
    For `gpt-4o-transcribe` models, the prompt is a free text string, for examples
