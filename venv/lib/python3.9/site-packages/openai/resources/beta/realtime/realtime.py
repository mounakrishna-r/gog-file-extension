...
class RealtimeInputAudioBufferResource(BaseRealtimeConnectionResource):
    ...
    def append(self, *, audio: str, event_id: str | NotGiven = NOT_GIVEN) -> None:
        ...
        of 15 MiB, for examples streaming smaller chunks from the client may allow the
...
class RealtimeConversationItemResource(BaseRealtimeConnectionResource):
    ...
    def retrieve(self, *, item_id: str, event_id: str | NotGiven = NOT_GIVEN) -> None:
        """
        Send this event when you want to retrieve the server's representation of a specific item in the conversation history. This is useful, for examples, to inspect user audio after noise cancellation and VAD.
