...
class BaseModel(pydantic.BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        This will **only** be set for the top-level response object, it will not be defined for nested objects. For examples:
    ...
    def to_dict(
        ...
        *,
        ...
        For examples, if the API responds with `"fooBar": true` but we've defined a `foo_bar: bool` property,
