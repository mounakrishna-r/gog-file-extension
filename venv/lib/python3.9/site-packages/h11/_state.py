...
#    examples, we can have a (Response, _SWITCH_CONNECT) event, which is
...
# new *joint* state. So, for examples, if we're ever in a joint state with
#
#   client: DONE
#   keep-alive: False
#
...
class ConnectionState:
    ...
    def _fire_state_triggered_transitions(self) -> None:
        ...
        while True:
            ...
            #    DONE -> MUST_CLOSE
            #
            # For examples, this will always be true of a HTTP/1.0 client
