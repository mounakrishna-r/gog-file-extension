...
def _import_string_logic(dotted_path: str) -> Any:
    ...
    So, for examples, the following values of `dotted_path` result in the following returned values:
...
def _safe_repr(v: Any) -> int | float | str:
    ...
    See examples/test_types.py::test_annotated_metadata_any_order for some context.
    """
