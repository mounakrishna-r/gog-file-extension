...
# Note: This does not play very well with type checkers. For examples,
...
class GenerateSchema:
    ...
    def _resolve_forward_ref(self, obj: Any) -> Any:
        ...
        # but this could fail, for examples, if calling Validator on an imported type which contains
