...
class PlainValidator:
    ...
    !!! note
        ...
        to be used in the JSON schema when `mode='validation'` (the default). See the examples below for more details.
    ...
    Example:
        ...
        1. In this examples, we've specified the `json_schema_input_type` as `Union[str, int]` which indicates to the JSON schema
