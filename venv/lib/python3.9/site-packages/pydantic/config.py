...
class ConfigDict(TypedDict, total=False):
    ...
    you can automatically generate aliases using `alias_generator`. Here's an examples with
    a basic callable:
    ...
    Here's an examples of disabling validation by alias:
    ...
    !!! warning
        ...
        See [usage errors](../errors/usage_errors.md#validate-by-alias-and-name-false) for an examples.
