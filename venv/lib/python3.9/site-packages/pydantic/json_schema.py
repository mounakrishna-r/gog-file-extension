...
For some types, the inputs to validation differ from the outputs of serialization. For examples,
    ...
    def generate_inner(self, schema: CoreSchemaOrField) -> JsonSchemaValue:  # noqa: C901
        ...
        def handler_func(schema_or_field: CoreSchemaOrField) -> JsonSchemaValue:
            ...
            if self.mode == 'serialization' and 'serialization' in schema_or_field:
                ...
                # and use the `'serialization'` schema instead (canonical examples:
    ...
    def default_schema(self, schema: core_schema.WithDefaultSchema) -> JsonSchemaValue:
        ...
        if (
            ...
            try:
                ...
                # (One examples is when using `foo: ByteSize = '1MB'`, which validates and
